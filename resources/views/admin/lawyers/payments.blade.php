<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-serif text-2xl text-ink-700">Pagos de {{ $lawyer->name }}</h2>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl space-y-4">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-5 py-10 text-center text-carbon/50">
                                Este abogado no tiene pagos registrados.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <a href="{{ route('admin.lawyers.index') }}" class="inline-flex text-sm text-ink-700 hover:text-brass-600 transition">
            &larr; Volver a abogados
        </a>
    </div>
</x-app-layout>
